...
public class CustomProgressBar extends View {
    ...
    private static final String CIRCLE_COLOR = "#FFFFFF";
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            stationaryCircleColor = typedArray.getColor(R.styleable.CustomProgressBar_stationary_circle_color, Color.parseColor(CIRCLE_COLOR));
            fadingCircleColor = typedArray.getColor(R.styleable.CustomProgressBar_fading_circle_color, Color.parseColor(CIRCLE_COLOR));
            oribitingCircleColor = typedArray.getColor(R.styleable.CustomProgressBar_orbiting_circle_color, Color.parseColor(CIRCLE_COLOR));
            roationDirection = typedArray.getInt(R.styleable.CustomProgressBar_direction, 0);
            rStationary = typedArray.getDimension(R.styleable.CustomProgressBar_stationary_circle_radius, 12f);
            float orbitingCircleRadius = typedArray.getDimension(R.styleable.CustomProgressBar_orbiting_circle_radius, 6f);
