...
public class MainActivity extends AppCompatActivity /*implements LocationListener */ {
    private static TextView tvlon;
    private static TextView tvlat;
    ...
    public static void mostrarDatos(double lat, double lng) {
        tvlat.setText(String.valueOf(lat));
        tvlon.setText(String.valueOf(lng));
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvlon=(TextView)findViewById(R.id.textView3);
